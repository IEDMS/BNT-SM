function inference_LRbnet(skill, bnet, structure, hash_evidence, C, header, inference_result, inference_prior)
...
[students cases] = get_LRevidence(hash_evidence, C, header, skill);
