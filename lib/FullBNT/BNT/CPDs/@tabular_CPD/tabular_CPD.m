...
switch CPD.prior_type
 case 'dirichlet',
  switch dirichlet_type
   case 'unif',
        CPD.dirichlet = myreshape(dirichlet_weight, fam_sz);
	% Kai-min's hardwired code
%       if dirichlet_weight==1, CPD.dirichlet = [9; 6];
%       elseif dirichlet_weight==2, CPD.dirichlet = [ [9 19]; [1 15] ];
%       elseif dirichlet_weight==3, CPD.dirichlet = [ [9 2]; [0  0] ]; end;    
